package com.codewithtee.ecommerce.email;

import com.codewithtee.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void  sendPaymentSuccessfulEmail(
        ...
        mimeMessageHelper.setFrom("codewithtee@gmail.com");
        ...
        try {
            ...
            log.warn("WARNING - Can not send message to " + destinationEmail);
        }
    }
